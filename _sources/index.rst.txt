...
To learn more about ``pubtools``, see the following documents:

- :ref:`projects` - a listing and brief explanation of ``pubtools`` projects
- :ref:`devguide` - how to develop ``pubtools`` projects
